    ...
    def say(score0, score1):
        if who == 0:
            if score0 - last_score > running_high: 
                running_temp = score0 - last_score
                print(running_temp, 'point(s)! The most yet for Player', who)
            else:
                running_temp = running_high
            return announce_highest(0, score0, running_temp)
        elif who == 1:
            if score1 - last_score > running_high: 
                running_temp = score1 - last_score
                print(running_temp, 'point(s)! The most yet for Player', who)
            else:
                running_temp = running_high
            return announce_highest(1, score1, running_temp)
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    for i in range(1,11):
        ...
        n = trials_count
        while(n):
            score += roll_dice(i, dice)
            n -= 1
        avg = score / trials_count
        if avg > avg_max:
            avg_max = avg
            max_index = i
    return max_index
